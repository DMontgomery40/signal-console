...
async function main(): Promise<void> {
  ...
  console.log(`capturing PBP revisions for ${games.length} games -> ${process.env.SIGNAL_CONSOLE_DB_PATH}`);
  ...
  console.log("done. Re-run on a cadence; diff with listPbpAttributionTransitions(gameId).");
}
