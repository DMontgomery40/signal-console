...
- **Single horizontal top nav** of seven text links: `Recent / Live / Backtest / Known Cases / Detectors / Research / Settings`. Active route gets a 2px `accent-green` underline (bet365's "All Sports" pattern). No sidebar.
