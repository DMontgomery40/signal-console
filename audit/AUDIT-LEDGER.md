...
| 5   | board-anomaly cluster (`shared/board-anomaly/*`): volatility-model / phase / classifier / residual / h0                                  | partial | F-009 (DOWNGRADED — type lives in dead surface, see F-010)                                                                                             |
...
**Open for owner:** (1) F-010 board-anomaly staged-vs-abandoned classification;
(2) fix go-ahead for F-009/F-011/F-012 (same as the F-001..F-007 batch).
**Docs:** `audit/HANDOFF-audit-fixes-2026-05-30.md`,
`docs/audit-2026-05-30-enforced-contracts.md`. Nothing committed/pushed.
