...
## APPLIED (on `main`, 2026-06-08)

Fixed by "fix(audit): collapse redundant BoardGameStateVolatility aliases
(F-009)" on the PR #9 branch: `state`/`headlineScore` dropped, `band`/`score`
canonical; producer, ranker tiebreak, alert builder, and tests repointed.
