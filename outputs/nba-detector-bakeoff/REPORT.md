...
Generated: 2026-05-28T11:23:35.709Z
...
| ----------------------------------------- | --------------: | -------------------: | ------------------------: | --------------: | ------------: | --------------------------------------------------------------------------------------------------------------------------------------------- |
| A00_runtime_state_space_live_defaults     |            0/15 |      304/5537 (5.5%) |                     69.3% |            0.34 |          0.34 | caution: This is the current live board runtime from detector-defaults.json; treat it as product truth, not as a generic research comparator. |
| A00_runtime_state_space_baseline_defaults |            0/15 |      446/5537 (8.1%) |                     51.3% |            0.67 |          0.67 | caution: Packaged baseline of the live Python runtime, useful only as a control against the currently saved live defaults.                    |
