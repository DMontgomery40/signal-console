...
This project is indexed by GitNexus as **signal-console** (8302 symbols, 13683 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
